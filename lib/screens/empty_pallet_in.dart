...
class EmptyPalletInScreenState extends State<EmptyPalletInScreen> {
  ...
  void _resetForm() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => EmptyPalletInScreen(),
      ),
    );
  }
  ...
  void _confirmForm() async {
    ...
    // Validate base pallet ID and number of pallets
    bool isBasePalletIdValid = _validateBasePalletId(basePalletId);
    bool isNumberOfPalletsValid = _validateNumberOfPallets(numberOfPallets) as bool;
  ...
  String _validateNumberOfPallets(String numberOfPallets) {
    if (NumberOfPalletsMandatory && numberOfPallets.isEmpty) {
      return 'Number of pallets is required';
    }
    ...
    int palletCount = int.tryParse(numberOfPallets) ?? 0;
    if (palletCount < minNumberOfPallets || palletCount > maxNumberOfPallets) {
      return 'Number of pallets should be between $minNumberOfPallets and $maxNumberOfPallets';
    }
                  ...
                  children: [
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            _numberOfPalletsError = _validateNumberOfPallets(value);
                          });
                        },
                        keyboardType: TextInputType.numberWithOptions(decimal: true),
                        inputFormatters: [
